# Contributing to pulsar-transformer
...
# Watch mode
pnpm --filter @pulsar-framework/transformer dev
```
...
```bash
pnpm --filter @pulsar-framework/transformer test
pnpm --filter @pulsar-framework/transformer typecheck
pnpm --filter @pulsar-framework/transformer lint
```
